  ...
  return (
    <div className="min-h-dvh pb-20" style={{background:'#f4f5f7'}}>
      ...
      <div className="px-4 pt-12 pb-6 text-center" style={{background:'linear-gradient(135deg, #1a1a2e 0%, #0f3460 100%)'}}>
        ...
        <div className="text-white text-xl font-bold">Alexandre M.</div>
        ...
        <div className="flex gap-3 justify-center">
          <div className="flex-1 rounded-2xl px-3 py-2" style={{background:'rgba(245,158,11,0.15)', border:'1px solid rgba(245,158,11,0.4)'}}>
            ...
            <div className="text-white/50 text-xs">⚡ Coins Play</div>
          </div>
          <div className="flex-1 rounded-2xl px-3 py-2" style={{background:'rgba(34,197,94,0.15)', border:'1px solid rgba(34,197,94,0.3)'}}>
            ...
            <div className="text-white/50 text-xs">🎁 Coins Fidélité</div>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 pt-4 flex flex-col gap-4">
        ...
        <div className="rounded-2xl bg-white p-4 shadow-sm">
          <div className="flex items-center justify-between mb-3">
            <div className="text-gray-500 text-xs font-bold uppercase tracking-wider">🎁 Coins Fidélité</div>
          ...
          <div className="flex justify-between items-center mb-1">
            <span className="text-sm text-gray-500">Solde fidélité</span>
          ...
          <div className="text-xs text-gray-400 mb-4">{coinsFidelite} / 2 000 pour un <strong>demi offert</strong></div>

          <div className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Récompenses disponibles</div>
          ...
          <div className="text-gray-400 text-xs mt-3 text-center">Coins fidélité = earned à chaque visite, non perdables en jeu</div>
        </div>
        ...
        <div className="rounded-2xl bg-white p-4 shadow-sm">
          ...
          <div className="text-center text-xs text-gray-400 mt-2">{coinsPlay.toLocaleString()} / 10 000 coins pour LEGEND</div>
        </div>

        {/* Badges */}
        <div className="rounded-2xl bg-white p-4 shadow-sm">
          <div className="text-gray-500 text-xs font-bold uppercase tracking-wider mb-3">Badges obtenus</div>
        ...
        <div className="rounded-2xl p-4 shadow-sm" style={{background:'linear-gradient(135deg,#1a1a2e,#0f3460)'}}>
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-white font-black text-sm">Prochainement sur BarCoins</span>
          ...
          <div className="flex gap-2 overflow-x-auto pb-1">
            {comingSoon.map((f, i) => (
              <div key={i} className="flex-shrink-0 rounded-xl p-3 w-32"
                ...
                <div className="text-white/40 text-xs mt-1 leading-tight">{f.desc}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="rounded-2xl bg-white p-4 shadow-sm flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-gray-400 text-sm">Narbonne — Membre depuis fév. 2026</div>
          </div>
        </div>
      </div>
